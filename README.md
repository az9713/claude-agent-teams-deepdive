...
how work is divided and integrated, and how teams are shut down. The result is
[AGENT_TEAM_CASE_STUDY.md](AGENT_TEAM_CASE_STUDY.md), a detailed behind-the-scenes
account of an entire Agent Team session with timelines, agent rosters, coordination
patterns, and conflict resolution examples.

If you've heard about the new **Agent Teams** feature in Claude Code and wondered
*"What actually happens when multiple agents work together?"* -- this project gives
you a concrete, real-world answer.
...
**7-phase implementation** using teams of builder agents. The result: a complete
Rust CLI application built from scratch by 11 coordinated agents in about 79 minutes.

## What You'll Find Here

| File | What It Contains |
|------|-----------------|
| [AGENT_TEAM_CASE_STUDY.md](AGENT_TEAM_CASE_STUDY.md) | The main deliverable -- a 719-line deep dive into Agent Team behavior with visual timelines, Gantt charts, agent roster, coordination patterns, and lessons learned |
...
(sequential) to ~79 minutes actual.
...
- 173 passing tests
- ~79 minutes wall-clock time
- ~1.9x parallel speedup vs sequential execution
